...
@RestController(value = "TestDB009.Table2Controller")
@Api(value = "/testDB009/Table2", description = "Exposes APIs to work with Table2 resource.")
@RequestMapping("/testDB009/Table2")
