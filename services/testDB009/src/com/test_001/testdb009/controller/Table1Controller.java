...
import com.test_001.testdb009.service.Table1Service;
import com.test_001.testdb009.service.Table2Service;
...
import com.test_001.testdb009.service.*;


/**
 * Controller object for domain model class Table1.
 * @see com.test_001.testdb009.Table1
 */

@RestController(value = "TestDB009.Table1Controller")
@Api(value = "/testDB009/Table1", description = "Exposes APIs to work with Table1 resource.")
@RequestMapping("/testDB009/Table1")
public class Table1Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Table1Controller.class);

	@Autowired
	@Qualifier("testDB009.Table1Service")
	private Table1Service table1Service;


    @Autowired
    @Qualifier("testDB009.Table2Service")
    ...
    @ApiOperation(value = "Gets the table2s instance associated with the given id.")
     public Page<Table2> findAssociatedtable2s(Pageable pageable, @PathVariable("id") String id){
...
public class Table1Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Returns the Table1 instance associated with the given id.")
    public Table1 getTable1(@PathVariable(value = "id") String id) throws EntityNotFoundException {
        LOGGER.debug("Getting Table1 with id: {}", id);
        Table1 instance = table1Service.findById(id);
        LOGGER.debug("Table1 details with id: {}", instance);
        return instance;
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Updates the Table1 instance associated with the given id.")
    public Table1 editTable1(@PathVariable(value = "id") String id, @RequestBody Table1 instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Table1 with id: {}", instance.getId());
        instance.setId(id);
        instance = table1Service.update(instance);
        LOGGER.debug("Table1 details with id: {}", instance);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    @ApiOperation(value = "Deletes the Table1 instance associated with the given id.")
    public boolean deleteTable1(@PathVariable(value = "id") String id) throws EntityNotFoundException {
        LOGGER.debug("Deleting Table1 with id: {}", id);
        Table1 deleted = table1Service.delete(id);
        return deleted != null;
    }
