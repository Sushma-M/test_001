 ...
 */
@Service("testDB009.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "testDB009TransactionManager")
    @Override
    ...
    public Table1 update(Table1 updated) throws EntityNotFoundException {
        ...
        String id = (String)updated.getId();
