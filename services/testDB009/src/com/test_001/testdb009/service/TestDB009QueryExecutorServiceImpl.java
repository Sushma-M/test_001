...
@Service
public class TestDB009QueryExecutorServiceImpl implements TestDB009QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(TestDB009QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("testDB009WMQueryExecutor")
